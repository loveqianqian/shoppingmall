...
$(function () {
    ...
    $('#porderGrid').datagrid({
        ...
        columns:[[
            ...
            {field:'purchaseOrderCode',title:'采购单号',width:100,halign:"center",align:"center"},
            {field:'providerName',title:'供货商名称',width:200,halign:"center",align:"center"},
            {field:'purchaseFee',title:'采购金额',width:100,halign:"center",align:"center"},
            {field:'makeOrderUser',title:'制单人',width:100,halign:"center",align:"center"},
            {field:'purchaseUser',title:'采购员',width:100,halign:"center",align:"center"},
