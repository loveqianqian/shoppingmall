...
$(function () {
    ...
    $('#goodInputGrid').datagrid({
        ...
        columns:[[
            ...
            {field:'inputTime',title:'入库时间',width:200,halign:"center",align:"center",
            ...
            {field:'operator',title:'操作',width:200,halign:"center",align:"center",
                formatter:function(value, row, index){
                    var a = '<a title="入库" class="btn btn-success" href="#"><i class="halflings-icon white zoom-in"></i></a>&nbsp;';
                    var b = '<a title="详情" class="btn btn-info" href="#"><i class="halflings-icon white edit"></i></a>&nbsp;';
                    return a + b;
                }
            }
        ]],
        toolbar:"#goodInputGridToolsBar"
    });
    //保存
