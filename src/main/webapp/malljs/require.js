...
$(function () {
    ...
    $('#requireGrid').datagrid({
        ...
        columns:[[
            ...
            {field:'orderCode',title:'订单编号',width:100,halign:"center",align:"center"},
            {field:'shopName',title:'便利店',width:100,halign:"center",align:"center"},
            {field:'address',title:'地址',width:100,halign:"center",align:"center"},
            {field:'contractUser',title:'联系人',width:100,halign:"center",align:"center"},
            {field:'contractWay',title:'联系方式',width:100,halign:"center",align:"center"},
            {field:'goodsInfo',title:'商品信息',width:100,halign:"center",align:"center"},
            {field:'kind',title:'类目',width:100,halign:"center",align:"center"},
            {field:'count',title:'数量',width:100,halign:"center",align:"center"},
            {field:'money',title:'金额',width:100,halign:"center",align:"center"},
            ...
            {field:'operator',title:'操作',width:200,halign:"center",align:"center",
                formatter:function(value, row, index){
                    var a = '<a title="分发" class="btn btn-success" href="#"><i class="halflings-icon white zoom-in"></i></a>&nbsp;';
