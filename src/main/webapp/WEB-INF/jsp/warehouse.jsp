...
<div class="row-fluid">
	...
	<!-- 工具条Div -->
	<div id="warehouseGridToolsBar" style="padding: 10px; height: 20px;">
		...
		<div class="span9">
			...
			<span>商品编码/名称: <input type="text" aria-controls="DataTables_Table_0"></span>
...
<script src="<%=path%>/malljs/warehouse.js"></script>
<script>
