...
<ul class="breadcrumb" style="margin: 0px;">
	...
	<li><a href="#">仓库商品列表</a></li>
</ul>
<div class="row-fluid">
	<div style="height: 755px;width: 100%;">
		<table id="houseGoodsGrid" ></table>
	</div>
	<!-- 工具条Div -->
	<div id="houseGoodsGridToolsBar" style="padding: 10px; height: 20px;">
		<div class="span12">
			...
			<span>商品编码: <input type="text" id="goodsCode" aria-controls="DataTables_Table_0"></span>
			<span>商品名称: <input type="text" id="goodsName" aria-controls="DataTables_Table_0"></span>
...
<script src="<%=path%>/malljs/warehouse-goods.js"></script>
<script>
