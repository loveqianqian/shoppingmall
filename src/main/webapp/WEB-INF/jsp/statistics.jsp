...
<ul class="breadcrumb" style="margin: 0px;">
	...
	<li><a href="#">便利店统计</a></li>
</ul>
<div class="row-fluid">
	<div style="height: 755px;width: 100%;">
		<table id="shopStatisticsGrid" ></table>
	</div>
	<!-- 工具条Div -->
	<div id="shopStatisticsGridToolsBar" style="padding: 10px; height: 20px;">
		<div class="span6" style="margin-bottom: 0px; float: left;">
		...
		<div class="span6">
			...
			<a href="#" style="margin-bottom: 7px;" class="easyui-linkbutton" iconCls="icon-search" plain="true">查询</a>
		</div>
	</div>
</div>
...
<script src="<%=path%>/malljs/statistics.js"></script>
<script>
