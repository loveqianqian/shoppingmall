...
<div class="row-fluid">
	<div style="height: 755px;width: 100%;">
		<table id="porderGrid" ></table>
	</div>
	<!-- 工具条Div -->
	<div id="porderGridToolsBar" style="padding: 10px; height: 20px;">
		...
		<div class="span9">
			...
			<span>采购单号: <input type="text" aria-controls="DataTables_Table_0"></span>
			<span>供应商名: <input type="text" aria-controls="DataTables_Table_0"></span>
...
<script src="<%=path%>/malljs/purchase-order.js"></script>
<script>
