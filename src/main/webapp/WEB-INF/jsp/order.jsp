...
<div class="row-fluid">
	...
	<!-- 工具条Div -->
	<div id="orderGridToolsBar" style="padding: 10px; height: 20px;">
		<div class="span12">
			<div class="controls" style="float: left;">
				<span>开始时间:</span>
				<input type="date" style="width: 130px;" id="startTime" value=""/>
				<span>结束时间:</span>
			...
			<span>订单号/便利店: <input type="text" id="searchValue" aria-controls="DataTables_Table_0"></span>
...
<script src="<%=path%>/malljs/order.js"></script>
<!-- end: JavaScript-->
<script>
