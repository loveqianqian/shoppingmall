...
<div class="row-fluid">
	...
	<!-- 工具条Div -->
	<div id="shopGridToolsBar" style="padding: 10px; height: 20px;">
		...
		<div class="span9">
			...
			<span>供应商名称: <input type="text" aria-controls="DataTables_Table_0"></span>
...
<script src="<%=path%>/malljs/shop.js"></script>
<script>
