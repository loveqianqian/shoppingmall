...
<div class="row-fluid">
	<div style="height: 755px;width: 100%;">
		<table id="goodsOutputGrid" ></table>
	</div>
	<!-- 工具条Div -->
	<div id="goodsOutputGridToolsBar" style="padding: 10px; height: 20px;">
		<div class="span3" style="margin-bottom: 0px; float: left;">
			<a href="#" data-target="#myModal" data-toggle="modal" class="easyui-linkbutton" iconCls="icon-add" plain="true">补货</a>
		</div>
		<div class="span9">
			...
			<span>单号/商品名称: <input type="text" aria-controls="DataTables_Table_0"></span>
...
<script src="<%=path%>/malljs/goods-output.js"></script>
<script>
