...
<div class="row-fluid">
	...
	<!-- 工具条Div -->
	<div id="financeGridToolsBar" style="padding: 10px; height: 20px;">
		<div class="span3" style="margin-bottom: 0px; float: left;">
			<a href="#" data-target="#myModal" data-toggle="modal" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
			<a href="#" class="easyui-linkbutton" iconCls="icon-undo" plain="true">导出</a>
		</div>
		<div class="span9">
			<div class="controls" style="float: left;">
				<span>开始时间:</span>
				<input type="date" id="satrtTime" value=""/>
				<span>结束时间:</span>
				<input type="date" id="endTime" value=""/>
			</div>
			<label class="control-label" style="float: left;" for="shopName">店铺：</label>
			<div class="controls" style="float: left;">
				<select id="shopName">
					<option value="0">全部</option>
					<option value="1">中北镇店</option>
					<option value="2">东兴里店</option>
				</select>
			</div>
			<%--<span>XXXX: <input type="text" aria-controls="DataTables_Table_0"></span>--%>
			<a style="float: left;" href="#" style="margin-bottom: 7px;" class="easyui-linkbutton" iconCls="icon-search" plain="true">查询</a>
		</div>
	</div>
</div>
...
<script src="<%=path%>/malljs/finance.js"></script>
<script>
