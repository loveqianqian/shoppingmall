...
<div class="row-fluid">
	...
	<!-- 工具条Div -->
	<div id="classifyGridToolsBar" style="padding: 10px; height: 20px;">
		<div class="span3" style="margin-bottom: 0px; float: left;">
			<a href="#" data-target="#myModal" data-toggle="modal" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加主分类</a>
		</div>
		<div class="span9">
			<span>分类名称: <input type="text" aria-controls="DataTables_Table_0"></span>
...
<script src="<%=path%>/malljs/classify.js"></script>
<script>
