...
<div class="row-fluid">
	...
	<!-- 工具条Div -->
	<div id="userGridToolsBar" style="padding: 10px; height: 20px;">
		...
		<div class="span9">
			<span>用户名: <input type="text" id="searchUserName" aria-controls="DataTables_Table_0"></span>
...
<div class="modal hide fade" id="myModal" style="width: 1000px;margin-left: -465px;">
		...
		<div class="box-content">
			<form class="form-horizontal" id="addUserForm">
				<fieldset>
					...
					<div class="control-group">
						<label class="control-label" for="roleCode">角色</label>
						<div class="controls">
							<select id="roleCode" multiple data-rel="chosen">
					...
					<div class="control-group">
						<div class="controls">
							...
							<input class="input-xlarge focused" id="loginTime" name="loginTime" type="hidden">
	...
	<div class="modal-footer">
		...
		<script src="<%=path%>/malljs/user.js"></script>
<script>
